$(".start").click(function () {
  ...
  fire_modal(
    ...
    "Ayoo membuat kuee!",
    "Berhubung ini ulang tahun pipiii, jadi ayoo buat kuee digitall. Tinggal campur campur pencet pencet, kuee siap disajikan. Yukk coba! (Jangan sampai ngembang jadi kue bolen yaa)"
  );
});
...
$(".mixer").click(function () {
  ...
  if (mixtimes == 6) {
    ...
    fire_modal(
      ...
      "Aduk adonan berhasilll!",
      "Selamatt, adonan sudah siap! Setelah nuangin adonan ke loyang, sekarang sudah waktunya masukin ke dalam oven digital kita selama sekitar 3 detik. Harusnya cukup yaa waktu untuk membuat dasar yang lembut."
    );
  }
});
...
$(".oven").droppable({
  drop: function (event, ui) {
    ...
    fire_modal(
      ...
      "Kuenya udah matanggg wowowowowow!",
      "YAYY! Pipiii pinter masak dehh. Basenya udah matang dan keliatan super yummy. Sekarang waktunya untuk menggabungkan basenya dengan banyak bahan lainnya seperti selai, coklat dan lainnya."
    );
  },
});
